  ...
  return (
    <div className="space-y-6">
      ...
      {!cardData && !isGenerating && (
        <div className="flex flex-col items-center justify-center py-16 bg-surface-raised rounded-2xl card-shadow">
          <div className="w-16 h-16 rounded-2xl bg-coral-light flex items-center justify-center mb-4">
      ...
      {isGenerating && (
        <div className="max-w-2xl mx-auto">
          <div className="animate-pulse">
            <div className="bg-coral-light rounded-t-2xl h-20" />
            <div className="bg-coral/30 h-10" />
            <div className="bg-surface-raised border border-t-0 border-separator-light rounded-b-2xl p-6 space-y-4">
              <div className="h-16 bg-coral-light rounded-xl" />
              ...
              <div className="space-y-3">
                ...
                <div className="h-16 bg-[#EAFBF0] rounded-lg" />
              </div>
      ...
      {cardData && !isGenerating && (
        <>
          ...
          {/* Share URL */}
          {shareUrl && (
            <div className="max-w-2xl mx-auto bg-[#EAFBF0] border border-[#34C759]/20 rounded-xl p-4">
              <p className="text-sm font-medium text-[#1B7A34] mb-2">
