...
const GENOTYPE_COLORS: Record<string, string> = {
  LQT1: 'bg-[#EBF2FF] text-[#1A56C4]',
  LQT2: 'bg-purple-100 text-purple-700',
  LQT3: 'bg-indigo-100 text-indigo-700',
  OTHER: 'bg-[#F2F2F7] text-[#6E6E73]',
  UNKNOWN: 'bg-[#F2F2F7] text-[#6E6E73]',
}
            ...
            <div>
              ...
              {totalMeds === 0 ? (
                ...
                <p className="font-semibold text-text-primary">
                  ...
                  {qtMeds > 0 && <span className="text-[#C41E16] ml-1">· {qtMeds} QT-prolonging</span>}
                </p>
              )}
            </div>
            <div className="flex items-center gap-1.5">
              {qtMeds > 0 && <div className="w-2.5 h-2.5 rounded-full bg-[#FF3B30]" />}
